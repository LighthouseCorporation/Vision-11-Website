...
export const metadata: Metadata = {
    title: "Article Details | Articles by Vision-11",
    description: "Articles worth your time",
    // other metadata
};
                            ...
                            <div>
                                ...
                                <div>
                                    ...
                                    <ul className="mb-10 list-inside text-body-color">
                                        {
                                            article?.details.listItems.map(item => (
                                    ...
                                    <div className="items-center justify-between sm:flex">
                                        <div className="mb-5">
                                            ...
                                            <div className="flex items-center">
                                                <TagButton text={article?.tags[1]} />
                                                <TagButton text={article?.tags[2]} />
                                                <TagButton text={article?.tags[3]} />
                                            </div>
                                        </div>
                                        <div className="mb-5">
