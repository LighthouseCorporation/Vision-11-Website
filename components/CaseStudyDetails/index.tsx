...
import caseStudyData from "../Articles/caseStudyData";

export const metadata: Metadata = {
    title: "Case Study Details | Case Studies by Vision-11",
    description: "Real Life examples of how Vision-11 is transforming lives",
    // other metadata
};
...
const CaseStudyDetails = ({ caseStudy }: { caseStudy: ArticleType }) => {
    function RenderBlogID({ id }: { id: string }) {
        ...
        const pathname = caseStudyData.find(item => item.id.toString() === id).path
    ...
    const nextItem = caseStudyData.find(item => item.id === caseStudy.id + 1)
    let nextPath = null
    if (nextItem) {
                ...
                <div className="container">
                    <div className="-mx-4 flex flex-wrap justify-center">
                        <div className="w-full px-4 lg:w-8/12">
                            <Link href="/case-studies" style={{ position: "absolute", left: 95, top: 150 }}>
                            ...
                            <div>
                                        ...
                                        <div className="mb-5 mr-10 flex items-center">
                                            ...
                                            <div className="w-full">
                                                <span className="mb-1 text-base font-medium text-body-color">
                                                    By <span>{caseStudy.author.name}</span>
                                                </span>
                                            </div>
                                        </div>
                                ...
                                <div>
                                    ...
                                    <p className="mb-8 text-base font-medium leading-relaxed text-body-color sm:text-lg sm:leading-relaxed lg:text-base lg:leading-relaxed xl:text-lg xl:leading-relaxed">
                                        {caseStudy.details.section1}
                                    </p>
                                    <p className="mb-10 text-base font-medium leading-relaxed text-body-color sm:text-lg sm:leading-relaxed lg:text-base lg:leading-relaxed xl:text-lg xl:leading-relaxed">
                                        {caseStudy.details.section2}
                                    </p>
                                    <h3 className="font-xl text-center mb-10 font-bold leading-tight text-black dark:text-white sm:text-2xl sm:leading-tight lg:text-xl lg:leading-tight xl:text-2xl xl:leading-tight">
                                        {caseStudy.details.subHeading}
                                    </h3>
                                    <p className="mb-10 text-base font-medium leading-relaxed text-body-color sm:text-lg sm:leading-relaxed lg:text-base lg:leading-relaxed xl:text-lg xl:leading-relaxed">
                                        {/* any extra notes below subheading */}
                                    </p>
                                    ...
                                    <div className="items-center justify-between sm:flex">
                                        <div className="mb-5">
                                            ...
                                            <div className="flex items-center">
                                                <TagButton text={caseStudy.tags[1]} />
                                                <TagButton text={caseStudy.tags[2]} />
                                                <TagButton text={caseStudy.tags[3]} />
                                            </div>
                                        </div>
                                        <div className="mb-5">
                    ...
                    <div className="w-full px-4">
                        <ul className="flex items-center justify-center pt-8">
                            <li>
                                {
                                    caseStudy.id != 1 && (
                                        <Link href="" onClick={() => { window.history.back(); window.scrollTo(0, 0) }}
                                            className="flex mx-1 h-9 min-w-[36px] items-center justify-center rounded-md bg-body-color bg-opacity-[15%] px-4 text-sm text-body-color transition hover:bg-primary hover:bg-opacity-100 hover:text-white"
                                        >
                                            Prev
                                        </Link>
                                    )
